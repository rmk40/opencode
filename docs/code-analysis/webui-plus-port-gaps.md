...
#### B8. `packages/app/src/index.css` — calmer progress, content-visibility gate, iOS PWA viewport, mobile bash mask — **PARTIALLY PORTED** (PWA viewport in commit 9; calmer progress + content-visibility gate in commit 15)
