...
export function SessionComposerRegion(props: {
  ...
  return (
    <div
      ...
      class="shrink-0 w-full pb-[calc(env(safe-area-inset-bottom)+0.375rem)] md:pb-[calc(env(safe-area-inset-bottom)+0.75rem)] flex flex-col justify-center items-center bg-background-stronger pointer-events-none"
    >
      <div
        classList={{
